 ...
 */
public class tools_CustomDatePicker {
    ...
    private tools_DatePickerView year_pv, month_pv, day_pv, hour_pv, minute_pv;
    ...
    private void initView() {
        year_pv = (tools_DatePickerView) datePickerDialog.findViewById(R.id.year_pv);
        month_pv = (tools_DatePickerView) datePickerDialog.findViewById(R.id.month_pv);

        day_pv = (tools_DatePickerView) datePickerDialog.findViewById(R.id.day_pv);

        hour_pv = (tools_DatePickerView) datePickerDialog.findViewById(R.id.hour_pv);
        minute_pv = (tools_DatePickerView) datePickerDialog.findViewById(R.id.minute_pv);
    ...
    private void addListener() {
        year_pv.setOnSelectListener(new tools_DatePickerView.onSelectListener() {
            @Override
        ...
        month_pv.setOnSelectListener(new tools_DatePickerView.onSelectListener() {
            @Override
            public void onSelect(String text) {
        ...
        day_pv.setOnSelectListener(new tools_DatePickerView.onSelectListener() {
            @Override
            public void onSelect(String text) {
        ...
        hour_pv.setOnSelectListener(new tools_DatePickerView.onSelectListener() {
            @Override
            public void onSelect(String text) {
        ...
        minute_pv.setOnSelectListener(new tools_DatePickerView.onSelectListener() {
            @Override
            public void onSelect(String text) {
...
//            minute_pv.setSelected(0);
    ...
    public void show(String time,int what) {
        if(what == 2) {
